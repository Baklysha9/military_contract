...
$('#send').on("click", function (event) { 
	if ( $('#exampleInputName1').val() == '' || $('#phone').val() == '' || $('#exampleFormControlTextarea1').val() == '') {
		return false;
	} else {
		alert('ВСЕ ОК');
	}
